  ...
  describe "| POST -> '/update_customer'" do
    context "with an existing person" do
      ...
      it "should update information on Highrise" do
        VCR.use_cassette(:retrieve_updated_update_customer) do
      ...
      it "should create tasks on Highrise" do
        VCR.use_cassette(:retrieve_updated_update_customer_with_tasks) do
    ...
    context "without an existing person" do
      ...
      it "should add person to Highrise" do
        VCR.use_cassette(:retrieve_created_update_customer) do
      ...
      it "should create tasks on Highrise" do
        VCR.use_cassette(:retrieve_created_update_customer_with_tasks) do
          Highrise::Task.all.map{|task| task.body }.should include *@customer[:highrise_tasks][:person].map{|task| task[:body] }
        end
      end
